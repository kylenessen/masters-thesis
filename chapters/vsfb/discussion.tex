...
Our results identify thermoregulation, light exposure, and diurnal rhythms as the primary drivers of short-term monarch movements at overwintering sites. These findings align with fundamental principles of insect physiology and behavior while revealing previously unrecognized complexity in monarch clustering dynamics.

\subsubsection{Thermoregulation as a Primary Driver}
...
The relatively low explanatory power of our best model (R² = 0.057) suggests that stochastic processes play a substantial role in short-term clustering dynamics. Monarch aggregation sites may function through positive feedback mechanisms, where initial settlement by a few individuals increases the probability of additional butterflies joining that location. This "seeding" behavior could create self-reinforcing clustering patterns independent of immediate environmental conditions. Such emergent social dynamics would make short-term movements difficult to predict from abiotic variables alone, while still producing the consistent year-to-year use of specific roost sites observed throughout the overwintering range.
...
The absence of wind constraints implies more potential habitat exists within current groves than previously recognized. Sites dismissed due to perceived wind exposure may actually provide suitable overwintering conditions if other key factorsparticularly appropriate light regimes and thermal conditionsare present. This expanded habitat potential could inform restoration efforts, including strategic canopy management to create favorable light patterns without requiring the problematic blue gum eucalyptus that dominates many current sites.

Our results strongly support continued emphasis on large trees, which clearly provide important structural complexity for clustering. Management strategies should prioritize the health of existing mature trees while establishing the next generation of roosting habitat. We recommend planting large trees at the highest density that supports healthy, long-lived growth. Trees can be selectively removed as our understanding improves, but they cannot be quickly grown to replace losses.
...
The monarch butterfly's overwintering phenomenon represents one of nature's most remarkable migrations, transforming coastal California groves into spectacular aggregations each winter. Our study demonstrates that wind, long considered a primary limiting factor for overwintering habitat, does not disrupt monarch clusters even at speeds far exceeding established thresholds. Instead, butterflies respond primarily to thermal conditions, light exposure, and diurnal rhythms that enable them to balance energy conservation with essential activities.

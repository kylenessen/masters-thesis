...
%% Font encoding - ensures < and > symbols render correctly in PDF
\usepackage[T1]{fontenc}

%% Define a display title with line break for title page only
\newcommand{\displaytitle}{Wind resilience in overwintering monarch butterflies: \\ An empirical test of the microclimate hypothesis}

%% This is to create placeholder text and shouldn't be in your thesis
\usepackage{lipsum}

%% For long tables spanning multiple pages (used in appendices)
